...
const Employeeedit = ({ isLoggedIn, setIsLoggedIn }) => {
  ...
  const router = useRouter();
    ...
    useEffect(() => {
        axios.get(`https://apitextilediwanji.work.gd/employeeedit/${srno}`, { withCredentials: true })
            .then(res => {
    ...
    const handlesubmit = (e) => {
        ...
        axios.put(`https://apitextilediwanji.work.gd/employeeeditput/${srno}`, values, {withCredentials:true} )
        .then(res => {
