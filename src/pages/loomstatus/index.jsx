...
const LoomStatus = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://api.textilediwanji.com/getloomnumber/data?loomnumber=${loomno}`, { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        ...
        if (designno.length < 1) {
            ...
            axios.get(`http://api.textilediwanji.com/getdesignnumber/data?dn=${designno}`, { withCredentials: true })
                .then(res => {
    ...
    useEffect(() => {
        ...
        if (design < 1) {
            ...
            axios.get(`http://api.textilediwanji.com/getdesignnumber/data?dn=${design}`, { withCredentials: true })
                .then(res => {
                    console.log(res.data);
    ...
    const handleupdate = (id) => {
        ...
        axios.get(`http://api.textilediwanji.com/loomstatusget/${id}`, { withCredentials: true })
            .then(res => {
                console.log(res.data);
    ...
    const handlemodalupdate = (id, e) => {
        ...
        if (ddesignnumber === "Design number not exit") {
            ...
            axios.put(`http://api.textilediwanji.com/loomstatusupdate/${id}`, data, { withCredentials: true })
                .then(res => {
    ...
    const handlesubmit = (e) => {
        ...
        if (dalert === "Design number not exit") {
            ...
            axios.post('http://api.textilediwanji.com/loomstatus', values, { withCredentials: true })
                .then(res => {
