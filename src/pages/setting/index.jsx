...
const Setting = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        axios.get('https://apitextilediwanji.work.gd/totalparty', { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        axios.get('https://apitextilediwanji.work.gd/totalcompany', { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        axios.get('https://apitextilediwanji.work.gd/totalbanks', { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        axios.get('https://apitextilediwanji.work.gd/shiftnumber', { withCredentials: true })
            .then(res => {
