...
const Setting = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        axios.get('http://api.textilediwanji.com/totalparty', { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        axios.get('http://api.textilediwanji.com/totalcompany', { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        axios.get('http://api.textilediwanji.com/totalbanks', { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        axios.get('http://api.textilediwanji.com/shiftnumber', { withCredentials: true })
            .then(res => {
