...
const YarnInwardEdit = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const fetchdata = async () => {
        try {
            const res = await axios.get(`http://api.textilediwanji.com/yarninwardedit/${srnoyarn}`, { withCredentials: true });
    ...
    const handlesubmit = (e) => {
        ...
        axios.put(`http://api.textilediwanji.com/yarninwardedit/${srnoyarn}`, formData, { withCredentials: true })
            .then(res => {
