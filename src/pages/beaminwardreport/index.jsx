...
const BeamInwardReport = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const handlestatus = (sta, e, srno) => {
        ...
        axios.put(`https://apitextilediwanji.work.gd:5000/updatestatus?srnumber=${srno}`, value, { withCredentials: true })
            .then(res => {
    ...
    const handledelete = (DesignNo) => {
        axios.delete(`https://apitextilediwanji.work.gd:5000/delete/${DesignNo}`, { withCredentials: true })
            .then((res) => {
                fetchdata();
    ...
    const sendReconsile = (Designno, setno, remail) => {
        ...
        axios.post("https://apitextilediwanji.work.gd:5000/mailreconsile", { heyurl, sendmail }, { withCredentials: true })
            .then(() => {
 ...
 <td style={{fontSize: "13px"}}>{report.Pick}</td> */}
                     ...
                     >
                         DELETE
                                                                ...
                                                                <td style={{fontSize: "13px"}}>
                                                                    {report.jacquardfile ? (
                                                                        <a href={`https://apitextilediwanji.work.gd:5000/jacquardfiles/${removeprefix(report.jacquardfile)}`} download>
