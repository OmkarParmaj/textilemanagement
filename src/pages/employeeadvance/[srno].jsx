...
const EmployeeAdvance = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        axios.get(`https://apitextilediwanji.work.gd/totaladvancetaken/${srno}`, { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        axios.get(`https://apitextilediwanji.work.gd/getemployeedetails/${srno}`, { withCredentials: true })
            .then(res => {
    ...
    const fetchdata = () => {
        setLoading(true)
        axios.get(`https://apitextilediwanji.work.gd/advancereport/data?srno=${srno}&startdate=${startdate}&enddate=${enddate}`, { withCredentials: true })
            .then(res => {
                console.log(res.data);
    ...
    const handlesubmit1 = (e) => {
        ...
        axios.post('https://apitextilediwanji.work.gd/giveadvance', values, { withCredentials: true })
            .then(res => {
    ...
    const handlesubmit2 = (e) => {
        ...
        axios.post('https://apitextilediwanji.work.gd/receivedamount', values, { withCredentials: true })
            .then(res => {
    ...
    const handledelete = (id) => {
        axios.delete(`https://apitextilediwanji.work.gd/employeeadvancedelete/${id}`, { withCredentials: true })
            .then(res => {
