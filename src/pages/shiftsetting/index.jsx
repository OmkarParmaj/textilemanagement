...
const ShiftSetting = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://apitextilediwanji.work.gd:5000/addshift', { shiftname }, { withCredentials: true })
            .then(res => {
    ...
    const handleDelete = (srno) => {
        axios.delete('https://apitextilediwanji.work.gd:5000/shiftdelete', { data: { srno }, withCredentials: true })
            .then(res => {
