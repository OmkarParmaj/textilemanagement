...
const Daterangepackingreport = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const fetchdata = async () => {
        try {
            ...
            setLoading2(true)
            const response = await axios.get(`http://api.textilediwanji.com/datewisepackingreport/data?startdate=${startdate}&enddate=${enddate}`, { withCredentials: true });
    ...
    const sendPackslip = (packing, ui, ser, ema) => {
        ...
        axios.post("http://api.textilediwanji.com/mailpackslip", { yesurl }, { withCredentials: true })
            .then(() => {
