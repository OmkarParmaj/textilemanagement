...
const Beaminward = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://apitextilediwanji.work.gd/getdesignnumber/data?dn=${values.DesignNo}`, { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        axios.get('https://apitextilediwanji.work.gd/beaminwarduniqueidno', { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        axios.get(`https://apitextilediwanji.work.gd/company`, { withCredentials: true })
            .then(res => {
                setCompany(res.data);
            })
            .catch(err => {
    ...
    useEffect(() => {
        axios.get('https://apitextilediwanji.work.gd/partyname', { withCredentials: true })
            .then(res => {
                setParty(res.data);
            })
            .catch(err => {
    ...
    const submitData = (e) => {
        ...
        if (dalert === "Design number already exist") {
            ...
            axios.post('https://apitextilediwanji.work.gd/beaminward', formData, {
