...
const Signup = () => {
    ...
    const sendmail = async () => {
        ...
        try {
            ...
            if (values.Email.length > 0) {
                ...
                const res = await axios.post('http://api.textilediwanji.com/sendotp', { email, newPin }, { withCredentials: true });
    ...
    const handleSubmit = (e) => {
        ...
        if (timeDifference > 300) {
            ...
            axios.post('http://api.textilediwanji.com/customer', values, {
