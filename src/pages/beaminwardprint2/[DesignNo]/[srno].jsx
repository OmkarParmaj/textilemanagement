...
const BeamInwardPrint2 = () => {
    ...
    const fetchdata = async () => {
        ...
        try {
            const res = await axios.get(`https://apitextilediwanji.work.gd:5000/beaminwardprintnew/${DesignNo}/${srno}`, {
  ...
  if (!auth) {
    ...
    return (
        <div className="container-fluid" >
            <div className="row d-flex justify-content-end align-items-center dontbeaminwardprint2button">
                <div className="col-2 d-flex justify-content-end align-items-center mt-3">
                    <button className="btn btn-success btn-sm" onClick={handleprint}>PRINT</button>

                </div>

            </div>
            <div className="row mt-2 printbeaminwardreport2">
...
export default BeamInwardPrint2;
