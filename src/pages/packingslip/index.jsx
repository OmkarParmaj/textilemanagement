...
const PackingSlip = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const handlestatus = (e) => {
        ...
        axios.put(`http://api.textilediwanji.com/packslipstatus?setnumber=${setno}&designnumber=${designno}`, { status }, { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        axios.get('http://api.textilediwanji.com/packslipnofetch', { withCredentials: true })
            .then(res => {
                const data = res.data;
                if (data.length > 0) {
    ...
    useEffect(() => {
        if (designno === "") {
            ...
            axios.post('http://api.textilediwanji.com/packislipbeam', { designno }, { withCredentials: true })
                .then(res => {
    ...
    //   try {
    //     await axios.post("http://api.textilediwanji.com/packslip", rows);
    ...
    const handleSubmit = (e) => {
        ...
        if (salert === "set number not exit") {
            ...
            axios.post('http://api.textilediwanji.com/packslip', payload, { withCredentials: true })
                .then(res => {
