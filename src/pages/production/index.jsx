...
const Production = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        setLoading(true)
        axios.get('http://api.textilediwanji.com/loomstatusdataforproduction', { withCredentials: true })
            .then(res => {
    ...
    const handlesubmit = (e) => {
        ...
        axios.post('http://api.textilediwanji.com/production', payload, { withCredentials: true })
            .then(res => {
