...
const Production = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        setLoading(true)
        axios.get('https://apitextilediwanji.work.gd/loomstatusdataforproduction', { withCredentials: true })
            .then(res => {
    ...
    const handlesubmit = (e) => {
        ...
        axios.post('https://apitextilediwanji.work.gd/production', payload, { withCredentials: true })
            .then(res => {
