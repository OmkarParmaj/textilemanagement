...
const Companybedit = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const fetchdata = async () => {
        try {
            setLoading(true)
            const res = await axios.get(`http://api.textilediwanji.com:5000/companybankedit/${srno}`, { withCredentials: true });
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`http://api.textilediwanji.com:5000/companybanked/${srno}`, bankDetails, { withCredentials: true })
            .then(res => {
