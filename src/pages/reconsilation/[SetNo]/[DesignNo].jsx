...
const Reconsilation = () => {
    ...
    useEffect(() => {
        axios.get(`http://api.textilediwanji.com/reconsilecompany/${SetNo}`, {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response1 = await axios.get(`http://api.textilediwanji.com/reconsilation/${SetNo}`, { withCredentials: true });
                const response2 = await axios.get(`http://api.textilediwanji.com/packslip/${SetNo}/${DesignNo}`, { withCredentials: true });
                const response3 = await axios.get(`http://api.textilediwanji.com/yarninward/${SetNo}`, { withCredentials: true });
                const response4 = await axios.get(`http://api.textilediwanji.com/billingreport/${SetNo}/${DesignNo}`, { withCredentials: true });
    ...
    useEffect(() => {
        axios.get(`http://api.textilediwanji.com/reconsilationbeaminward/${SetNo}/${DesignNo}`, { withCredentials: true })
            .then(res => {
                                    ...
                                    <div className="card-body">
                                        <div className="row d-flex justify-content-end align-items-center">
                                            <div className="col-3 d-flex justify-content-end">
                                                ...
                                                <Link href={`http://www.textilediwanji.com/reconsilationprint?SetNo=${SetNo}&DesignNo=${DesignNo}`} className="btn btn-success btn-sm ms-2">Print</Link>
                                            ...
                                            <div className="container border border-1 mobilecontainer ">
                                                ...
                                                <div className="row">
                                                    <div className="col-4 col-md-2  border-bottom d-flex justify-content-center align-items-center ">
                                                        <img src={`http://api.textilediwanji.com/companyimage/${company.filenameas}`} style={{ maxWidth: 250, maxHeight: 90 }} alt={`Image ${company.filenameas}`} />
                                                    </div>
