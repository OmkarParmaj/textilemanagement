...
const PackingSlipReport = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const handlefetch = async () => {
        try {
            ...
            setLoading2(true)
            const response = await axios.get('http://api.textilediwanji.com/packingslipreport', { withCredentials: true });
    ...
    const handledelete = (id) => {
        axios.delete(`http://api.textilediwanji.com/packingdelete/${id}`, { withCredentials: true })
            .then(res => {
    ...
    const sendPackslip = (packing, ui, ser, mai) => {
        ...
        axios.post("http://api.textilediwanji.com/mailpackslip", { yesurl, maid }, { withCredentials: true })
            .then(() => {
    ...
    const handlebillnumber = (srno, billnumber) => {
        axios.put(`http://api.textilediwanji.com/putbillnumberinpackingslip`, { srno, billnumber }, { withCredentials: true })
            .then(res => {
