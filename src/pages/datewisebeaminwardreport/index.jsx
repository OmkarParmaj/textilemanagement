...
const Datewisebeaminwardreport = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const fetchdata = () => {
        setLoading2(true)
        axios.get(`https://apitextilediwanji.work.gd:5000/datewisebeaminwardreport/data?startdate=${startdate}&enddate=${enddate}`, {
    ...
    const sendReconsile = (Designno, setno, remail) => {
        ...
        axios.post("https://apitextilediwanji.work.gd:5000/mailreconsile", { heyurl }, { withCredentials: true })
            .then(() => {
