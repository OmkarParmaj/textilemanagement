...
const Datewisebeaminwardreport = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const fetchdata = () => {
        setLoading2(true)
        axios.get(`https://apitextilediwanji.work.gd/datewisebeaminwardreport/data?startdate=${startdate}&enddate=${enddate}`, {
    ...
    const sendReconsile = (Designno, setno, remail) => {
        ...
        axios.post("https://apitextilediwanji.work.gd/mailreconsile", { heyurl }, { withCredentials: true })
            .then(() => {
