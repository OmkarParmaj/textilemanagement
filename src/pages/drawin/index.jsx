...
const DrawIn = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        ...
        if (designno === "") {
            ...
            axios.get(`https://apitextilediwanji.work.gd/getbeaminwarddatafordrawin?setnumber=${setno}&designnumber=${designno}`, { withCredentials: true })
                .then(res => {
    ...
    const handlesubmit = (e) => {
        ...
        if (notpresent === "Design number is not present") {
            ...
            axios.post(`https://apitextilediwanji.work.gd/drawinpost`, values, { withCredentials: true })
                .then(res => {
