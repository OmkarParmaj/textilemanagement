...
const DrawIn = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const fetchdata = () => {
        ...
        axios.get(`https://apitextilediwanji.work.gd:5000/getdrawindata/data?startdate=${startdate}&enddate=${enddate}`, { withCredentials: true })
            .then(res => {
                // //console.log(res.data)
    ...
    useEffect(() => {
        ...
        if (designno === "") {
            ...
            axios.get(`https://apitextilediwanji.work.gd:5000/getbeaminwarddatafordrawin?setnumber=${setno}&designnumber=${designno}`, { withCredentials: true })
                .then(res => {
    ...
    const handlesubmit = (e) => {
        ...
        if (notpresent === "Design number is not present") {
            ...
            axios.post(`https://apitextilediwanji.work.gd:5000/drawinpost`, values, { withCredentials: true })
                .then(res => {
