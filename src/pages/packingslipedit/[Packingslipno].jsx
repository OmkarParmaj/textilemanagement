...
const PackingSlipEdit = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const fetchData = async () => {
        try {
            ...
            setLoading(true)
            const response = await axios.get(`https://apitextilediwanji.work.gd/packingslipedit/${Packingslipno}`, { withCredentials: true });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (Packingslipno) {
                const res = await axios.put(`https://apitextilediwanji.work.gd/packingslipedit/${Packingslipno}`, payload, { withCredentials: true });
                ...
                const res = await axios.post("https://apitextilediwanji.work.gd/packslip", payload, { withCredentials: true });
                // //console.log(res.data);
