...
const Header = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        axios.get('http://api.textilediwanji.com:5000/headerinfo', { withCredentials: true })
            .then(res => {
    ...
    //     try {
    //         const res = await axios.post('http://api.textilediwanji.com:5000/logout', {}, { withCredentials: true });
