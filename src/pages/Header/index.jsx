...
const Header = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        axios.get('http://api.textilediwanji.com/headerinfo', { withCredentials: true })
            .then(res => {
    ...
    //     try {
    //         const res = await axios.post('http://api.textilediwanji.com/logout', {}, { withCredentials: true });
