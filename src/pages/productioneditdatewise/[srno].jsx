...
const ProductionEditDatewise = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://apitextilediwanji.work.gd/get_productiondata_editone/${srno}`, { withCredentials: true })
            .then(res => {
    ...
    const handlesubmit = (e) => {
        ...
        axios.put(`https://apitextilediwanji.work.gd/productioneditput/${srno}`, payload, { withCredentials: true })
            .then(res => {
        ...
        // axios.post('https://apitextilediwanji.work.gd/production2', payload2, { withCredentials: true })
        //     .then(res => {
                                ...
                                <div className='card-body'>
                                    <form onSubmit={handlesubmit} >
                                                            ...
                                                            <tbody>
                                                                {rows.map((row, index) => (
                                                                    <tr key={index}>
                                                                        ...
                                                                        <td><button className="btn btn-danger btn-sm" type="button" onClick={() => deleteRow(index)}>DELETE</button></td>
                                                                    </tr>
                                                                ))}
                                                            </tbody>
                                                            <tfoot>
                                        ...
                                        <div className="row mt-3 d-flex justify-content-end">
                                            <div className="col-2">
                                                <button className="btn btn-primary btn-sm float-end mb-4" type="submit">SUBMIT</button>
                                            </div>
                                        </div>
                                    </form>
