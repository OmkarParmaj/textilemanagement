...
const YarnInward = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        ...
        if (rowData.Designno.length < 1) {
            ...
            axios.get(`http://api.textilediwanji.com/getdesignnumber/data?dn=${rowData.Designno}`, { withCredentials: true })
                .then(res => {
    ...
    useEffect(() => {
        ...
        if (rowData.setNo.length < 1) {
            ...
            axios.get(`http://api.textilediwanji.com/getdesignnumber2/data?dn=${rowData.setNo}`, { withCredentials: true })
                .then(res => {
                    console.log(res.data);
    ...
    const handleSubmit = (e) => {
        ...
        if (dalert === "Design number not exit") {
            ...
            axios.post('http://api.textilediwanji.com/yarninward', formData, { withCredentials: true })
                .then(res => {
                    setLoading(false);
