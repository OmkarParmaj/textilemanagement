...
const Login = ({ setIsLoggedIn }) => {
    ...
    const handleClick = () => {
        ...
        signInWithPopup(auth, provider).then((data) => {
            ...
            axios.post('http://api.textilediwanji.com/googleauth', { email, name, uid, phonenumber }, { withCredentials: true })
                .then(res => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault(); 
        setLoading(true)
        axios.post('http://api.textilediwanji.com/login', values, { withCredentials: true })
            .then(res => {
