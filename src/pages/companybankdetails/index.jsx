...
const CompanyBankDetails = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    const fetchdata = async () => {
        ...
        try {
            setLoading(true)
            const res = await axios.get('https://apitextilediwanji.work.gd/companybankdetails', { withCredentials: true })
    ...
    const handlesubmit = (e) => {
        ...
        axios.post('https://apitextilediwanji.work.gd/companybankdetails', payload, { withCredentials: true })
            .then(res => {
    ...
    const handleDelete = (id) => {
        axios.delete(`https://apitextilediwanji.work.gd/bankdetaildelete/${id}`, { withCredentials: true })
            .then(res => {
